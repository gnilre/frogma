...
import java.awt.Image;
  ...
  * @version 1.0
  */
public class Ari extends DynamicObject {
	...
	public int monsterSpeed=4;
        ...
        public static byte DEATHSTART=2;
        public static byte DEATHEND=2;
        public static byte DEATHOFFSET=3;
	 ...
	 * @param monsterImage
	 */
	public Ari(int tW, int tH, GameEngine referrer, Image monsterImage){
