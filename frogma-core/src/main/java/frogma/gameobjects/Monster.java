 ...
 * @version 1.0
 */
public final class Monster extends DynamicObject {
    ...
    static {
        ...
        oparInfo.setParam(0, Const.PARAM_TYPE_OBJECT_REFERENCE, new int[0], "Test Obj Link", new String[0]);
        oparInfo.setParam(1, Const.PARAM_TYPE_OBJECT_REFERENCE, new int[0], "Test Obj Link", new String[0]);
    }
    ...
    public String getName() {
        return Monster.typeName[this.type];
    }
}
